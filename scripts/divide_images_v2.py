...
root = r"C:\Users\joekh\OneDrive\Desktop\Senior Design Code\BreaKHis_v1\BreaKHis_v1\histology_slides\breast\"
        ...
        for subtype in os.listdir(classDir):
            ...
            for file in os.listdir(subclassDir):
                ...
                if randomnum<float(0.7):
                    print("Copy "+file+" to folder "+ os.path.join(root,"train",classification,subtype))
                    shutil.copy(os.path.join(subclassDir, file), os.path.join(root,"train",classification,subtype))
