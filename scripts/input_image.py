...
model.load_state_dict(torch.load(r"C:\Users\joekh\OneDrive\Desktop\Senior Design Code\model_v2\vgg_subclass_model_state_dict.pt",map_location=torch.device('cpu')))
model.eval()
...
for folder in os.listdir(r"C:\Users\joekh\OneDrive\Desktop\Senior Design Code\test"):
    for i in os.listdir(os.path.join(r"C:\Users\joekh\OneDrive\Desktop\Senior Design Code\test",folder)):
        try:
            image = image_loader(loader, os.path.join(r"C:\Users\joekh\OneDrive\Desktop\Senior Design Code\test",folder, i))
